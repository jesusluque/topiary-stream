...
$PY -u src/eval_stream.py --artifact ${LAB:-$HOME/luc/nanite-moe}/models/qwen3-30b-4bit-fine-taper085 --stage kld --kld-decode --data-general $D --chunks-general 4 --chunk-len 512 --kld-out runs/kld30_base_long.npz --tag k30base_long >> runs/kld30.log 2>&1 && echo '=== KLD-30B BASE OK ===' >> $LOG
